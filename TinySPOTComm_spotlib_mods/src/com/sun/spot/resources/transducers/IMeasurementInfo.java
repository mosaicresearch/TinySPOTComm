 ...
 * <p>
 * Similar to the MeasurementRange class in the JSR 256 spec.
 */
public interface IMeasurementInfo {
     ...
     * as a percentage of reading (=data value).
     * Because this accuracy value describes the relative measurement error,
     * greater values indicate a less accurate sensor.
     * The accuracy value is within: 0 &le; accuracy &lt; 1
     *
     * @return the accuracy of the sensor.
