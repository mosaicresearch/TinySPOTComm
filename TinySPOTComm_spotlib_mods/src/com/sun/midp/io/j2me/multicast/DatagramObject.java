...
import javax.microedition.io.MulticastDatagram;

/**
 * Implements a UDP datagram for the UDP datagram connection.
 */
public class DatagramObject implements MulticastDatagram {
    ...
    public DatagramObject(byte[] buf, int len) {
        //FIXME: this may have weird side effects
        setData(buf, 0, len);
    }
    ...
    public void setAddress(String addr) {
        ...
        if (url.scheme == null || !(url.scheme.equals("multicast") || url.scheme.equals("datagram"))) {
...
// #ifdef ENABLE_CLDC_11
     ...
     * @exception  IOException   if an I/O error occurs
     * @see        java.io.DataOutput#writeFloat(float f)
     */
     ...
     * @exception  IOException   if an I/O error occurs
     * @see        java.io.DataOutput#writeDouble(double v)
     */
