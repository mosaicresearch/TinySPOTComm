 ...
 */
class AddBroadcastConnectionCommand extends RadioRequestEnvelope {
	private byte portNo;
	
	public AddBroadcastConnectionCommand(byte portNo) {
		this.portNo = portNo;
	}

	public ReplyEnvelope execute(IRadioProtocolManager radioProtocolManager) {
		ConnectionID theConnectionId = ((IRadiogramProtocolManager) radioProtocolManager).addBroadcastConnection(portNo);
