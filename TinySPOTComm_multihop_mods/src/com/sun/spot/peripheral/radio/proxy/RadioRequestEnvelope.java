...
abstract class RadioRequestEnvelope extends RequestEnvelope {
	...
	public ReplyEnvelope execute(Object context) throws Exception {
		return execute(((IRadioServerContext)context).getRadioProtocolManager());
	}

	public abstract ReplyEnvelope execute(IRadioProtocolManager radioProtocolManager) throws Exception;
}
