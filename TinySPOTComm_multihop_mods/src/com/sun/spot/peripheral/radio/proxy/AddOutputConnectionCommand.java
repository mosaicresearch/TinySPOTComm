 ...
 */
class AddOutputConnectionCommand extends RadioRequestEnvelope {
	private byte portNo;
	private long macAddress;
	
	public AddOutputConnectionCommand(long macAddress, byte portNo) {
		this.portNo = portNo;
		this.macAddress = macAddress;
	}

	public ReplyEnvelope execute(IRadioProtocolManager radioProtocolManager) {
		ConnectionID theConnectionId = radioProtocolManager.addOutputConnection(macAddress, portNo);
